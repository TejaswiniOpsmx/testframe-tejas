...
package com.opsmx.oes.pipelinebuilder.json.stages.model;

import com.opsmx.oes.pipelinebuilder.json.contexts.CheckConditionsContext;
...
import com.opsmx.oes.pipelinebuilder.json.contexts.WebhookContext;
...
public class StageTypes {
    ...
    public class AWS {
        /**
         * stages specified for aws.
         */
        public final String DEPLOY = "deploy";
        public final String fIND_IMAGE_FROM_TAGS = "findImageFromTags";
        public final String DESTROY_SERVER_GROUP = "destroyServerGroup";
