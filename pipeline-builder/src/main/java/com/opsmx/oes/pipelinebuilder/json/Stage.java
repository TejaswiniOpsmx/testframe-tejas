...
package com.opsmx.oes.pipelinebuilder.json;

import com.opsmx.oes.pipelinebuilder.json.artifacts.ExpectedArtifact;
import com.opsmx.oes.pipelinebuilder.json.artifacts.InputArtifact;
import com.opsmx.oes.pipelinebuilder.json.contexts.ContextObject;
import com.opsmx.oes.pipelinebuilder.json.enums.FailureStrategy;
import com.opsmx.oes.pipelinebuilder.json.helpers.ListHelpers;
import com.opsmx.oes.pipelinebuilder.json.notifications.Notification;
import com.opsmx.oes.pipelinebuilder.json.notifications.NotificationEvent;
import com.opsmx.oes.pipelinebuilder.json.notifications.NotificationLevel;
import com.opsmx.oes.pipelinebuilder.json.restrictions.ExecutionWindow;
...
public class Stage extends HashMap<String, Object> {
    ...
    public Stage(String id, String name, String type,
                 ...
                 String comments, ExecutionWindow restrictExecutionTime, String jenkinsJob,
                 String jenkinsMaster, String jenkinsPropertyFile) {
        ...
        if (jenkinsMaster != null) {
            put("master", jenkinsMaster);
        }
        if (jenkinsPropertyFile != null) {
            put("propertyFile", jenkinsPropertyFile);
        }
