...
package com.opsmx.oes.pipelinebuilder.pipelines;
...
public abstract class JsonPipelineBuilder {
    ...
    @Getter private String pipelineName = null;
     ...
     */
    protected abstract Pipeline buildPipeline(final String appName, final String pipelineName);
    ...
    public Pipeline build() {
        final Pipeline generatedPipeline = buildPipeline(application, pipelineName);
