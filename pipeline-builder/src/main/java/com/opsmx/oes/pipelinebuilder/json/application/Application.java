...
public class Application {
    ...
    private final List<Map<String, Object>> job;

    @Builder
    public Application(String application, List<Map<String, Object>> job, String cloudProviders, DataSources dataSources, String description, String email, String name,
