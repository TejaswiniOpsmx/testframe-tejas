...
public class DockerTrigger extends Trigger {
    ...
    /** Account that the docker image is a part of. */
    ...
    public DockerTrigger(String id, String runAsUser, Boolean enabled, List<String> expectedArtifactIds, // parent parameters first
        String organization, String registry, String repository, String account, String tag) {
        ...
        this.account = Objects.requireNonNull(account, "Docker trigger needs a account");
